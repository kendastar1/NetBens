...
public class matriz extends javax.swing.JFrame {
   ...
   public int Com = 0,Com1 = 0;
    ...
    private void initComponents() {
        ...
        jButton5.setIcon(new javax.swing.ImageIcon("C:\\Users\\ESTUDIANTE19.DESKTOP-AG2B2N0.000\\Downloads\\arrows-switch-vertical_98216.png")); // NOI18N
    ...
    for(int a = 0; a < matriz1.length; a++){
        for(int b = 0; b < matriz1[a].length; b++){
            matriz1[a][b] = aleatorio.nextInt(Com1 - Com )+Com;
        }
    }
